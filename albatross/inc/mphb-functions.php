...
add_filter('mphbr_list_comments_args', 'albatross_mphbr_list_comments_args');

function albatross_mphbr_list_comments_args($args) {
	$args['callback'] = 'albatross_review_callback';
	return $args;
}